...
public static class SpriteTools
{
    ...
    public static Vector3 MoonshineLocationScreenSpace()
    {
        return new Vector3(Screen.width, Screen.height / 2, 10);
    }

    public static Vector3 MoonshineLocationWorldSpace()
    {
        Vector3 MoonshineLocation = MoonshineLocationScreenSpace();
        return Camera.main.ScreenToWorldPoint(MoonshineLocation);
    }

    public static Vector3 CorgiLocationScreenSpace()
    {
        return new Vector3(Screen.width / 2, Screen.height / 2, 10);
    }

    public static Vector3 CorgiLocationWorldSpace()
    {
        Vector3 corgiLocation = CorgiLocationScreenSpace();
        return Camera.main.ScreenToWorldPoint(corgiLocation);
    }
}
